...
const OperationAppCreateApp = "/daemon.api.daemon.app.v1.App/CreateApp"
const OperationAppDeleteApp = "/daemon.api.daemon.app.v1.App/DeleteApp"
const OperationAppGetApp = "/daemon.api.daemon.app.v1.App/GetApp"
const OperationAppListApp = "/daemon.api.daemon.app.v1.App/ListApp"
const OperationAppUpdateApp = "/daemon.api.daemon.app.v1.App/UpdateApp"
const OperationAppUpdateAppStatus = "/daemon.api.daemon.app.v1.App/UpdateAppStatus"
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	r := s.Route("/")
	r.GET("/daemon/client/v1/app", _App_GetApp0_HTTP_Handler(srv))
	r.GET("/daemon/api/v1/app", _App_GetApp1_HTTP_Handler(srv))
	r.GET("/daemon/api/v1/apps", _App_ListApp0_HTTP_Handler(srv))
	r.POST("/daemon/api/v1/app", _App_CreateApp0_HTTP_Handler(srv))
	r.PUT("/daemon/api/v1/app", _App_UpdateApp0_HTTP_Handler(srv))
	r.PUT("/daemon/api/v1/app/status", _App_UpdateAppStatus0_HTTP_Handler(srv))
	r.DELETE("/daemon/api/v1/app", _App_DeleteApp0_HTTP_Handler(srv))
}
...
func (c *AppHTTPClientImpl) UpdateAppStatus(ctx context.Context, in *UpdateAppStatusRequest, opts ...http.CallOption) (*UpdateAppStatusReply, error) {
	...
	pattern := "/daemon/api/v1/app/status"
	path := binding.EncodeURL(pattern, in, false)
