...
const OperationChannelCreateChannel = "/daemon.api.daemon.channel.v1.Channel/CreateChannel"
const OperationChannelDeleteChannel = "/daemon.api.daemon.channel.v1.Channel/DeleteChannel"
const OperationChannelListChannel = "/daemon.api.daemon.channel.v1.Channel/ListChannel"
const OperationChannelListChannelType = "/daemon.api.daemon.channel.v1.Channel/ListChannelType"
const OperationChannelUpdateChannel = "/daemon.api.daemon.channel.v1.Channel/UpdateChannel"
...
func RegisterChannelHTTPServer(s *http.Server, srv ChannelHTTPServer) {
	r := s.Route("/")
	r.GET("/daemon/api/v1/channel/types", _Channel_ListChannelType0_HTTP_Handler(srv))
	r.GET("/daemon/api/v1/channels", _Channel_ListChannel0_HTTP_Handler(srv))
	r.POST("/daemon/api/v1/channel", _Channel_CreateChannel0_HTTP_Handler(srv))
	r.PUT("/daemon/api/v1/channel", _Channel_UpdateChannel0_HTTP_Handler(srv))
	r.DELETE("/daemon/api/v1/channel", _Channel_DeleteChannel0_HTTP_Handler(srv))
}
...
func (c *ChannelHTTPClientImpl) ListChannel(ctx context.Context, in *ListChannelRequest, opts ...http.CallOption) (*ListChannelReply, error) {
	...
	pattern := "/daemon/api/v1/channels"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChannelHTTPClientImpl) ListChannelType(ctx context.Context, in *ListChannelTypeRequest, opts ...http.CallOption) (*ListChannelTypeReply, error) {
	...
	pattern := "/daemon/api/v1/channel/types"
	path := binding.EncodeURL(pattern, in, true)
