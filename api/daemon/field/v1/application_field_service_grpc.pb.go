...
const (
	Field_ListFieldType_FullMethodName = "/daemon.api.daemon.field.v1.Field/ListFieldType"
	Field_ListField_FullMethodName     = "/daemon.api.daemon.field.v1.Field/ListField"
	Field_CreateField_FullMethodName   = "/daemon.api.daemon.field.v1.Field/CreateField"
	Field_UpdateField_FullMethodName   = "/daemon.api.daemon.field.v1.Field/UpdateField"
	Field_DeleteField_FullMethodName   = "/daemon.api.daemon.field.v1.Field/DeleteField"
)
...
var Field_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "daemon.api.daemon.field.v1.Field",
	...
	Metadata: "api/daemon/field/application_field_service.proto",
}
