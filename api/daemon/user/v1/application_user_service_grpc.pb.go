...
const (
	User_GetCurrentUser_FullMethodName    = "/daemon.api.daemon.user.v1.User/GetCurrentUser"
	User_UpdateCurrentUser_FullMethodName = "/daemon.api.daemon.user.v1.User/UpdateCurrentUser"
	User_GetUser_FullMethodName           = "/daemon.api.daemon.user.v1.User/GetUser"
	User_ListUser_FullMethodName          = "/daemon.api.daemon.user.v1.User/ListUser"
	User_CreateUser_FullMethodName        = "/daemon.api.daemon.user.v1.User/CreateUser"
	User_ImportUser_FullMethodName        = "/daemon.api.daemon.user.v1.User/ImportUser"
	User_ExportUser_FullMethodName        = "/daemon.api.daemon.user.v1.User/ExportUser"
	User_UpdateUser_FullMethodName        = "/daemon.api.daemon.user.v1.User/UpdateUser"
	User_UpdateUserStatus_FullMethodName  = "/daemon.api.daemon.user.v1.User/UpdateUserStatus"
	User_DeleteUser_FullMethodName        = "/daemon.api.daemon.user.v1.User/DeleteUser"
	User_GetTrashUser_FullMethodName      = "/daemon.api.daemon.user.v1.User/GetTrashUser"
	User_ListTrashUser_FullMethodName     = "/daemon.api.daemon.user.v1.User/ListTrashUser"
	User_DeleteTrashUser_FullMethodName   = "/daemon.api.daemon.user.v1.User/DeleteTrashUser"
	User_RevertTrashUser_FullMethodName   = "/daemon.api.daemon.user.v1.User/RevertTrashUser"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "daemon.api.daemon.user.v1.User",
	...
	Metadata: "api/daemon/user/application_user_service.proto",
}
